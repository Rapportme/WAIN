 ...
 *
 * PHONE / WHATSAPP: the three values below (build variables NEXT_PUBLIC_PHONE,
 * NEXT_PUBLIC_PHONE_DISPLAY, NEXT_PUBLIC_WHATSAPP override them if set).
 ...
 * Emptied, every call and WhatsApp button stays hidden and the
 * schema carries no telephone — nothing half-filled ever ships.
 */
export const CONTACT = {
  email: "hello@wearein.in",
  phone: (process.env.NEXT_PUBLIC_PHONE || "+917356092437").replace(/\s+/g, ""),
  phoneDisplay: process.env.NEXT_PUBLIC_PHONE_DISPLAY || "+91 73560 92437",
  whatsapp: (process.env.NEXT_PUBLIC_WHATSAPP || "917356092437").replace(/\D+/g, ""),
